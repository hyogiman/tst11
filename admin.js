    ...
    try {
        ...
        let html = `
            <div class="player-detail">
                ...
                <p><strong>상태:</strong> ${activeData && activeData.isActive ? 
                    (activeData.isAlive ? '<span class="status-alive">생존</span>' : '<span class="status-dead">사망</span>') : 
                    '<span style="color: #6c757d;">미접속</span>'}</p>
            </div>
        `;
